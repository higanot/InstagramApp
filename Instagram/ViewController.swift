...
import UIKit
import ESTabBarController //追加１
import Firebase // 追加２
import FirebaseAuth // 追加２
...
class ViewController: UIViewController {
  ...
  func setupTab() {
    ...
    // 背景色、選択時の色を設定する
    tabBarController.selectedColor = UIColor(red: 1.0, green: 0.4, blue: 0.11, alpha: 1)
    ...
    tabBarController.setAction( {
      // buttonが押されたらImageViewControllerをモーダルで表示する
